...
class _SosButtonState extends ConsumerState<SosButton> {
  ...
  Widget build(BuildContext context) {
    ...
    // Breve ventana entre que se suelta el botón y que `active` pasa a true
    // (ver SosState.activating) — sin esto el botón volvía a verse idle en
    // ese lapso, como si el gesto no hubiera hecho nada, justo durante una
    // emergencia real.
    if (sos.activating) {
...
// Se muestra en el breve lapso entre soltar el botón/gesto y que
// Sos.activate() marca active = true (el SOS ya no espera al GPS para
// activar, ver sos_provider.dart). Antes de esto el botón volvía de
// inmediato a su estado idle en ese lapso, sin ninguna señal de que el
// gesto sí se había registrado.
